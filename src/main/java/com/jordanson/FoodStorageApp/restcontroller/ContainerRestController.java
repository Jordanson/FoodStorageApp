...
public class ContainerRestController {
	...
	public Container updateContainer(@RequestBody Container container) {
		...
		//i did not have any issues adding an employee prior to adding @transactional, however
	}
	...
	public String deleteContainer(@PathVariable int containerId) {
		...
		if (container == null) {
			throw new RuntimeException("The employee is not found - " + containerId);
		}
		
		containerDAO.deleteById(containerId);
		
		return "Deleted employee id - " + containerId;
	}
}